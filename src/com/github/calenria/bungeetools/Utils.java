...
public final class Utils {
    ...
    public static String replaceFrom(final String text, final String from, BungeeTools plugin) {
        String search = text.trim();
        String prefix = "";
    ...
    public static String replaceTo(final String text, final String to, final String msg, BungeeTools plugin) {
        String search = text.trim();
        String prefix = "";
        String toPlayer = to;
        try {
